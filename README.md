...
Стажерский кейс по продуктовой аналитике, выполненный в формате timed-задания (60 минут на расчёт + защита). Демонстрирует полный цикл: от сырых транзакционных данных до статистически обоснованной бизнес-рекомендации.
...
**Вывод:** рост продаж, объясняется температурным фактором, а не промо-акцией как таковой. Строгий причинный вывод о промо невозможен — все 60 магазинов участвовали в акции одновременно, контрольной группы без промо не было.
...
- Нужно также учитывать район открытия
- Окупилась ли затрата на привлечение клиентов
